...
function createApplication(applicationFormData) {
    ...
    return fetch("https://localhost:9443/api/applicationForm/uaopApplication", requestOptions).then(handleResponse);
}
...
function updateApplication(applicationId, applicationFormData) {
    ...
    return fetch("https://localhost:9443/api/applicationForm/uaopApplication/"+applicationId, requestOptions).then(handleResponse);
}
