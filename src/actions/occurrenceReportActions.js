...
export const LOAD_OCCURRENCE_REPORTS_SUCCESS =
  "LOAD_OCCURRENCE_REPORTS_SUCCESS";
export const LOAD_OCCURRENCE_REPORTS_FAILURE =
  "LOAD_OCCURRENCE_REPORTS_FAILURE";
