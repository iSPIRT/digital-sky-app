...
export const LOAD_USER_AIRSPACE_CATEGORIES_SUCCESS = "LOAD_USER_AIRSPACE_CATEGORIES_SUCCESS";
export const LOAD_USER_AIRSPACE_CATEGORIES_FAILURE = "LOAD_USER_AIRSPACE_CATEGORIES_FAILURE";
