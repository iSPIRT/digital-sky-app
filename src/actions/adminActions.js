...
export const LOAD_AIRSPACE_CATEGORY_LIST_SUCCESS = "LOAD_AIRSPACE_CATEGORY_LIST_SUCCESS";
export const LOAD_AIRSPACE_CATEGORY_LIST_FAILURE = "LOAD_AIRSPACE_CATEGORY_LIST_FAILURE";
