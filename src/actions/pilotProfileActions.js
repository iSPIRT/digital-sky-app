...
export const createPilotProfileAction = pilotProfile => {
  return dispatch => {
    dispatch(request());
    userService.createPilotProfile(pilotProfile).then(
      savedProfile => {
  ...
  function request() {
    return { type: SAVE_PILOT_PROFILE_REQUEST };
  }
  function success(pilotProfile) {
    return { type: SAVE_PILOT_PROFILE_SUCCESS, pilotProfile };
  }
  function failure(errors) {
    return { type: SAVE_PILOT_PROFILE_FAILURE, errors };
  }
};
...
export const updatePilotProfileAction = (pilotProfileId, pilotProfile) => {
  return dispatch => {
    dispatch(request());
    userService.updatePilotProfile(pilotProfileId, pilotProfile).then(
      updatedProfile => {
...
export const loadPilotProfile = pilotProfileId => {
  ...
  function success(pilotProfile) {
    return { type: LOAD_PILOT_PROFILE_SUCCESS, pilotProfile };
  }
  function failure(errors) {
    return { type: LOAD_PILOT_PROFILE_FAILURE, errors };
  }
};
