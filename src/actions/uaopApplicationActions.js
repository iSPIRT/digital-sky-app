...
export const createApplicationAction = (applicationFormData) => {
    ...
    return dispatch => {
        dispatch(request());
        uaopApplicationService.createApplication(applicationFormData)
                    .then(
                        savedApplication => {
    ...
    function request()  { return { type: SAVE_UAOP_APPLICATION_REQUEST } }
    function success(application) { return { type: SAVE_UAOP_APPLICATION_SUCCESS, application } }
    function failure(errors) { return { type: SAVE_UAOP_APPLICATION_FAILURE, errors } }
}
...
export const updateApplicationAction = (applicationId, applicationFormData) => {
    ...
    return dispatch => {
        dispatch(request());
        uaopApplicationService.updateApplication(applicationId, applicationFormData)
                    .then(
                        savedApplication => {
                            dispatch(success(savedApplication));
                        },
...
export const loadApplicationAction = (applicationId) => {
    return dispatch => {
        uaopApplicationService.loadApplication(applicationId)
                    .then(
                        loadedApplication => {
    ...
    function success(application) { return { type: LOAD_UAOP_APPLICATION_SUCCESS, application } }
    function failure(errors) { return { type: LOAD_UAOP_APPLICATION_FAILURE, errors } }
}
