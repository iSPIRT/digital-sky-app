                            ...
                            <div className="grid-x grid-padding-x">
                                ...
                                <div className="large-12 cell">
                                    <label>Address
                                        ...
                                        <RegionDropdown type="text" placeholder="State" country={profile.addressList && profile.addressList[0].country} name="addressList.0.state" onChange={this.selectRegion} value={profile.addressList && profile.addressList[0].state} showDefaultOption={false} className={decorateInputClass(this.state.fieldErrors['addressList.0.state'],[])} validate="required,alphabetsOnly" onBlur={(e) => this.setState({fieldErrors: validateField(this.state.fieldErrors, e.target)})}/>
                                        <FieldError fieldErrors={this.state.fieldErrors} field='addressList.0.state'/>

                                        <CountryDropdown type="text" placeholder="Country" name="addressList.0.country" onChange={this.selectCountry} value={profile.addressList && profile.addressList[0].country} showDefaultOption={false} className={decorateInputClass(this.state.fieldErrors['addressList.0.country'],[])} validate="required,alphabetsOnly" onBlur={(e) => this.setState({fieldErrors: validateField(this.state.fieldErrors, e.target)})}/>
