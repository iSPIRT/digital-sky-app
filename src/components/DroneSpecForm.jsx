...
class DroneSpecForm extends React.Component {
    ...
    handleChange(event) {
        var changedDroneType = this.props.onChange(event);
    ...
    render() {
        ...
        const selectApplicableIsEmpty = ( selectedDroneType && 
            selectedDroneType.hasGNSS != null && 
            selectedDroneType.hasAutonomousFlightTerminationSystem != null && 
            selectedDroneType.hasFlashingAntiCollisionStrobeLights != null &&
            selectedDroneType.hasRFID_GSM_SIMCard != null && 
            selectedDroneType.hasFlightController != null)
